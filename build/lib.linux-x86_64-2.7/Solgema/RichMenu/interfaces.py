...
class ISolgemaRichMenuAttributesBase(Interface):
...
if has_p5:
    class ISolgemaRichMenuAttributes(model.Schema, ISolgemaRichMenuAttributesBase):
    ...
    class ISolgemaRichMenuAttributes(ISolgemaRichMenuAttributesBase):
        """Default Attributes"""
