...
class z3cManageSolgemaRichMenuAttributes(form.EditForm):
    ...
    def fields(self):
        ...
        if has_rel and portal_quickinstaller.isProductInstalled('plone.app.widgets'):
            fields['section_menu_item'].widgetFactory[INPUT_MODE] = RelatedItemsFieldWidget
        elif has_ctree:
            fields['section_menu_item'].field.vocabulary = UUIDSourceBinder(navigation_tree_query=None, portal_type=['Document', 'Folder', 'Collage', 'Topic', 'Collection'])
